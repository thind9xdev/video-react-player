...
export function getPointerPosition(
  ...
  const boxY = box.top;
  const boxX = box.left;
  let evtPageY = (event as MouseEvent).pageY;
  let evtPageX = (event as MouseEvent).pageX;
...
// blur an element
export function blurNode(reactNode?: HTMLElement | null) {
...
// focus an element
export function focusNode(reactNode?: HTMLElement | null) {
