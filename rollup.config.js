...
function baseConfig() {
  return {
    input: 'src/video-react-player.ts',
    plugins: [
      sass({
        output: 'dist/video-react-player.css',
      }),
      nodeResolve({
...
libConfig.output = [
  {
    sourcemap: true,
    name: 'video-react-player',
    file: 'dist/video-react-player.cjs.js',
    format: 'cjs',
  },
  {
    sourcemap: true,
    name: 'video-react-player',
    file: 'dist/video-react-player.es.js',
    format: 'es',
  },
];
...
/*
  ...
  video-react-player has two versions:

  1) `video-react-player.min.js`
  ...
  2) `video-react-player.full.min.js`
...
umdFullConfig.output = [
  {
    ...
    sourcemap: true,
    name: 'video-react-player',
    file: 'dist/video-react-player.full.js',
    format: 'umd',
  },
];
...
umdFullConfigMin.output = [
  {
    ...
    sourcemap: true,
    name: 'video-react-player',
    file: 'dist/video-react-player.full.min.js',
    format: 'umd',
  },
];
...
umdConfig.output = [
  {
    ...
    sourcemap: true,
    name: 'video-react-player',
    file: 'dist/video-react-player.js',
    format: 'umd',
  },
];
...
umdConfigMin.output = [
  {
    ...
    sourcemap: true,
    name: 'video-react-player',
    file: 'dist/video-react-player.min.js',
    format: 'umd',
  },
];
